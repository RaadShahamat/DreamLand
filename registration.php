...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO user_reg (username,email, password) VALUES (?, ?, ?)";
    ...
    <div class="wrapper">
        <div class="wrapper-inside">
            ...
            <form class="login_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="check">
                    <input type="checkbox" id="boxcheck" name="checkbox" required />
                    <label for="checkbox">I agreed all terms and conditions</label>
                </div>
                <div class="form-group">
                    <input type="submit" class="login-btn" value="Sign Up">
                    <input type="reset" class="reset-btn" value="Reset">
                </div>
                <p>Already have an account? <a href="login.php" class="triggerLogin">Login</a></p>
            </form>
        </div>
    </div>    
</body>
